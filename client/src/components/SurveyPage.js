    ...
    pages: [
      {
        ...
        elements: [
          ...
          },
          {
            ...
            name: "Impairments",
            title:
              "Any physical impairments or injuries dealing with range of motion? Explain below.",
            isRequired: true
          },
          {
            type: "comment",
          ...
          },
          {
            ...
            title:
              "Any mental impairments such as autism, schizophrenia, PTSD, etc.? Explain below.",
            isRequired: true
          },
          {
            type: "comment",
            name: "Reason",
            title:
              "Why do you feel you need a creative life coach? Describe what is going on.",
            isRequired: true
          },
          {
            type: "comment",
            name: "Goals",
            title:
              "Do you have any specific goals you wish addressed during these sessions?",
            isRequired: true
          },
          {
            type: "comment",
            ...
            title:
              "When did you begin to realize there was a problem with your creative process?",
            isRequired: true
          },
          {
            type: "comment",
            name: "Trauma",
            title:
              "Can you recall any trauma that occurred prior to your awareness?",
            isRequired: true
          },
          {
            type: "comment",
          ...
          },
          {
            ...
            isRequired: true,
            choices: ["Painting", "Drawing", "Printmaking", "Clay", "Other"]
          },
          {
            type: "checkbox",
            name: "Business owner",
          ...
          },
          {
            ...
            name: "Art goals",
            title:
              "What are your personal goals regarding your art? Check one or describe in greater detail.",
            isRequired: true,
            choices: [
              "Just a hobby",
          ...
          },
          {
            ...
            isRequired: true,
            choices: ["Social spirit", "Storyteller weaver", "Ghost"]
          },
          {
            type: "text",
            name: "Email",
